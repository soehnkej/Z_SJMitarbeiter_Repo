			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ProjectABAP-display": {
								"semanticObject": "ProjectABAP",
								"action": "display",
								"description": "Abap Project",
								"title": "Project-ABAP",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=abap.ABAP-Project",
									"url": sap.ui.require.toUrl("abap/ABAP-Project")
								}
							}
						}
					}
